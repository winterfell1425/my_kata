...
public class KataTestSuite {
    ...
    public void testDivision() {
        assertTrue(Arrays.equals(new int[] {2,4,6}, Division.divisibleBy(new int[] {1,2,3,4,5,6},2)));
        assertTrue(Arrays.equals(new int[] {3,6}, Division.divisibleBy(new int[] {1,2,3,4,5,6},3)));
        assertTrue(Arrays.equals(new int[] {0,4}, Division.divisibleBy(new int[] {0,1,2,3,4,5,6},4)));
    }
    @Test
    public void testSolution() {
        //Given&When
        Solution solution = new Solution();
        int numOfOperations = solution.solutionRoot(2, 20);
        //Then
        assertEquals(2, numOfOperations);
    }
    @Test
    public void testSuzuki() {
        ...
        assertEquals(expectedResult, Suzuki.stairsIn20(stairs));
    }
    @Test
    public void testSummation() {
        assertEquals(36, Grasshopper.summation(8));
        assertEquals(1, Grasshopper.summation(1));
        assertEquals(45, Grasshopper.summation(9));
    }
    @Test
    public void testCube() {
        Cube c = new Cube();
        c.setSide(34);
        assertEquals(34, c.getSide());
    }
   /*@Test
    public void testMixedArray() {
        MixedArray mixedArray = new MixedArray();

        assertEquals(10, mixedArray.sum(Arrays.asList(5,"5")));
        assertEquals(22, mixedArray.sum(Arrays.asList(9, 3, "7", "3")));
        assertEquals(42, mixedArray.sum(Arrays.asList("5", "0", 9, 3, 2, 1, "9", 6, 7)));
        assertEquals(41, mixedArray.sum(Arrays.asList("3", 6, 6, 0, "5", 8, 5, "6", 2, "0")));
        assertEquals(45, mixedArray.sum(Arrays.asList("1", "5", "8", 8, 9, 9, 2, "3")));
        assertEquals(41, mixedArray.sum(Arrays.asList("3", 6, 6, 0, "5", 8, 5, "6", 2, "0")));
        assertEquals(61, mixedArray.sum(Arrays.asList(8, 0, 0, 8, 5, 7, 2, 3, 7, 8, 6, 7)));
    }*/
   @Test
   public void testPointsTotal() {
